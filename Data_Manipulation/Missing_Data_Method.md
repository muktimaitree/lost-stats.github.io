Missing data Method- Missing at Random
...
However, once we condition on experience and gender, the missingness does not depend on the true education value itself.
Thus, the data satisfies the MAR assumption.
